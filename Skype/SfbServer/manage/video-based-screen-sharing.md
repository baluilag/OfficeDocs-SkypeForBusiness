...
- If someone is using Skype for Business on Mac hosted in an environment where the july 2018 Cumulative Update doesn't install and not is homed on Skype for Business Online.
